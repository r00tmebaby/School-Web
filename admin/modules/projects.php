...
<section class="panel important">
    ...
    if ($content && $title) {
        if (isset($_POST['addspec'])) {
            mysqli_query(isDbConnected(), "Insert into projects (
					title,
					category,
					content) values 
            ...
            mysqli_query(isDbConnected(), "Update projects SET 
				title = '{$title}' ,
				category = '{$category}',
				content = '{$content}'
    ...
    $content_f = isset($_SESSION['spec']['content']) ? $_SESSION['spec']['content'] : "";
...
<section class="panel important">
    ...
    <div class="twothirds">
        <form enctype="multipart/form-data" method="post">
            ...
            <div class="half-inputs">
                ...
                <select id="selectcategory" name="category">
                    ...
                    if (isset($_SESSION['new_category'])) {
                        ...
                        $cats = mysqli_query(isDbConnected(), "Select * from projects where category != '' group by category order by category");
            ...
            <textarea name="content"><?php echo $content_f ?></textarea><br/>
